...
export default function HomePage() {
  ...
  return (
    <div className="h-full w-full bg-background">
      ...
      <ScrollProgress />
      {/* Hero Section */}
      <section id="hero-section" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-0 bg-gradient-to-t from-[#27c08d]/25 via-[#27c08d]/10 to-transparent">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 items-center">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              <Image
                ...
                fill
                priority
                className="object-cover rounded-full border-4 border-[#27c08d]/20 shadow-lg"
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              أستاذ / شهاب عز الرجال
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8">
              جرب يمكن اختيارك صح
            </p>
            <Button size="lg" asChild className="bg-[#27c08d] hover:bg-[#27c08d]/90 text-white">
              <Link href="/sign-up">
                ...
                <div className="text-center py-12">
                  <div className="max-w-md mx-auto">
                    ...
                    <Button 
                      variant="outline" 
                      asChild
                      className="bg-[#27c08d] hover:bg-[#27c08d]/90 text-white border-[#27c08d]"
                    >
                      <Link href="/sign-up">
            ...
            {[
              {
                ...
                testimonial: "تجربة رائعة مع الأستاذ شهاب، شرح مميز وطريقة سهلة في توصيل المعلومة"
              },
              {
                name: "سيف طارق",
      ...
      <section className="py-20 bg-muted/50">
        ...
        >
          ...
          >
            ...
            >
              <div className="w-12 h-12 bg-[#27c08d]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Star className="h-6 w-6 text-[#27c08d]" />
              </div>
            ...
            >
              <div className="w-12 h-12 bg-[#27c08d]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="h-6 w-6 text-[#27c08d]" />
              </div>
            ...
            >
              <div className="w-12 h-12 bg-[#27c08d]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Award className="h-6 w-6 text-[#27c08d]" />
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <Button size="lg" asChild className="bg-[#10B981] hover:bg-[#10B981]/90 text-white">
              <Link href="/sign-up">
